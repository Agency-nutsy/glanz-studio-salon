...
const transformations = [
  {
    before: '/salon/1.png',
    after: '/salon/2.png',
    label: 'Hair Smoothening Transformation',
  },
  {
    before: '/salon/3.png',
    after: '/salon/4.png',
    label: 'Keratin Treatment Transformation',
  },
];
  ...
  return (
    <div className={styles.sliderWrap}>
      ...
      >
        ...
        <img src={after} alt="After transformation at Glanz Studio" style={{ zIndex: 1 }} />

        {/* Before image (clipped) */}
        <div style={{ position: 'absolute', top: 0, left: 0, width: `${position}%`, height: '100%', overflow: 'hidden', zIndex: 2 }}>
          <img src={before} alt="Before transformation at Glanz Studio" style={{ width: containerRef.current ? containerRef.current.offsetWidth + 'px' : '100%', maxWidth: 'none', height: '100%', objectFit: 'contain' }} />
        </div>
    ...
    <section className={`section ${styles.section}`}>
      <div className="container">
        <div className="section-header" data-aos="fade-up">
          ...
          <p className="section-subtitle">Drag the slider to see real before & after results from Glanz Studio.</p>
        </div>
