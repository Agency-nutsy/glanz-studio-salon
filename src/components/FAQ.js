...
const faqs = [
  {
    ...
    a: 'Appointments are recommended for the best experience. You can book easily via WhatsApp at +91 76690 71755. Walk-ins are welcome based on availability.',
  },
  {
    q: 'What services does Glanz Studio offer?',
  ...
  {
    q: 'Is Glanz Studio wheelchair accessible?',
  ...
  },
  {
    ...
    a: 'Pricing depends on hair length and the specific treatment. Please contact us via WhatsApp or call +91 76690 71755 for a personalized quote.',
  },
  {
    q: 'Where is Glanz Studio located?',
  ...
  {
    q: 'Is Glanz Studio good for kids?',
    a: 'Yes, our salon is kid-friendly and we welcome young clients.',
  },
  {
    q: 'Can I see your work before booking?',
    a: 'Yes! Check out our Gallery page or visit our Instagram @glanzstudio to see our latest transformations and client work.',
  },
];
