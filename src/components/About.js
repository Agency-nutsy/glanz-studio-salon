...
const features = [
  ...
  { icon: '⭐', text: '4.3 Stars — 455 Reviews' },
];
      ...
      <div className={`container ${styles.grid}`}>
        ...
        <div className={styles.imageStack} data-aos="fade-right">
          <div className={styles.img1}>
            <img
              src="/salon/interior-1.webp"
              alt="Glanz Studio salon interior with styling chairs and wash basins in Lajpat Nagar, Delhi"
              width={600}
              height={450}
              loading="lazy"
              decoding="async"
          ...
          <div className={styles.img2}>
            <img
              src="/salon/interior-2.webp"
              alt="Elegant interior view of Glanz Studio with arched mirrors and premium decor"
              width={600}
              height={450}
              loading="lazy"
              decoding="async"
          ...
          <div className={styles.floatingCard}>
            <span className={styles.floatingRating}>★ 4.3 / 5</span>
            <span className={styles.floatingText}>Based on 455 Google Reviews</span>
          </div>
        </div>
        ...
        <div className={styles.text} data-aos="fade-left">
          ...
          <p className={styles.body}>
            Glanz Studio Unisex Salon is a premium unisex salon and makeup studio nestled in the
            heart of Lajpat Nagar, New Delhi. Known for exceptional bridal makeup, expert hair makeovers,
            and meticulous attention to detail, Glanz Studio has earned a loyal following of clients who
          ...
          <p className={styles.body}>
            ...
            warm, welcoming space designed for comfort and luxury. Rated 4.3★ on Google with 455
