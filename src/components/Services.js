...
const services = [
  ...
  { cat: 'Makeup', icon: '👰', name: 'Bridal Makeup', desc: 'Complete bridal look  including draping assistance.', price: 'Price on request', duration: '2–3 hrs' },
        ...
        <div className={styles.grid}>
          {filtered.map((service, i) => (
            ...
            >
              ...
              <a
                href={`https://wa.me/917669071755?text=${encodeURIComponent(`Hi! I'd like to book "${service.name}" at Glanz Studio.`)}`}
                target="_blank"
