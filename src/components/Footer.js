...
const trustSignals = [
  { icon: '⭐', text: '4.3★ Google Rating' },
  { icon: '📝', text: '455+ Reviews' },
    ...
    <footer className={styles.footer}>
      <div className="container">
        <div className={styles.grid}>
          ...
          <div className={styles.col}>
            <Link href="/" className={styles.logo}>
              ...
              <span>GLANZ STUDIO</span>
            </Link>
            <p className={styles.tagline}>Luxury Hair, Makeup & Beauty Redefined.</p>
            <p className={styles.blurb}>
              New Delhi&apos;s trusted unisex salon. Expert stylists, premium services,
              and a warm, welcoming space for everyone.
            </p>
            <div className={styles.socials}>
              <a href="https://www.instagram.com/glanzstudio/?hl=en" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className={styles.socialIcon}>📷</a>
              <a href="https://wa.me/917669071755" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className={styles.socialIcon}>💬</a>
              <a href="https://maps.app.goo.gl/D518NHYhTGEq6Q1W6" target="_blank" rel="noopener noreferrer" aria-label="Google Maps" className={styles.socialIcon}>📍</a>
            </div>
          </div>
          ...
          <div className={styles.col}>
            ...
            <div className={styles.contactInfo}>
              ...
              <p><a href="tel:+917669071755">📞 +91 76690 71755</a></p>
              <p>🕐 10:00 AM – 9:00 PM (All Days)</p>
            </div>
            <a
              href="https://wa.me/917669071755?text=Hi%2C%20I%20want%20to%20book%20an%20appointment"
              target="_blank"
        ...
        <div className={styles.bottom}>
          <p>© {new Date().getFullYear()} Glanz Studio Unisex Salon. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
