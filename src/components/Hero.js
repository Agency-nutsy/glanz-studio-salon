        ...
        <div className={styles.grid}>
          ...
          <div className={styles.left}>
            ...
            <p className={styles.subtitle}>
              Step into Glanz Studio Unisex Salon — where luxury meets precision. From stunning bridal transformations to expert hair makeovers, we craft bespoke beauty experiences that reveal the most confident you.
            </p>

            <div className={styles.ctas}>
              <a
                href="https://wa.me/917669071755?text=Hi%2C%20I%20would%20like%20to%20book%20an%20appointment"
                target="_blank"
            ...
            <div className={styles.stats} ref={statsRef}>
              <div className={styles.stat}>
                <span className="counter-value" data-target="4.3" data-suffix="">{mounted ? '0' : '4.3'}</span>
                <span className="counter-label">Google Rating</span>
              </div>
              <div className={styles.statDivider}></div>
              <div className={styles.stat}>
                <span className="counter-value" data-target="455" data-suffix="+">{mounted ? '0' : '455+'}</span>
          ...
          <div className={styles.right}>
            <div className={styles.imageGrid}>
              ...
              <div className={`${styles.imgWrap} ${styles.imgMain}`}>
                <img
                  src="/salon/6.png"
                  alt="Nail art at Glanz Studio Unisex Salon"
                  loading="eager"
                  decoding="async"
                />
              </div>
              ...
              <div className={`${styles.imgWrap} ${styles.imgTopRight}`}>
                <img
                  src="/salon/5.png"
                  alt="Hair styling at Glanz Studio Unisex Salon"
                  loading="lazy"
                  decoding="async"
                />
              </div>
              ...
              <div className={`${styles.imgWrap} ${styles.imgBottomLeft}`}>
                <img
                  src="/salon/7.png"
                  alt="Bridal makeup session at Glanz Studio Unisex Salon"
                  loading="lazy"
                  decoding="async"
                />
              </div>
