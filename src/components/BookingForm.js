...
export default function BookingForm() {
  ...
  const handleSubmit = (e) => {
    ...
    const waText = `Hello Glanz Studio! 🙏\n\nI would like to book an appointment.\n\n👤 Name: ${name}\n📞 Phone: ${phone}\n✂️ Service: ${service}\n📅 Date: ${date}\n⏰ Time: ${time}\n📝 Notes: ${message || 'None'}\n\nPlease confirm my booking. Thank you!`;

    setShowConfirmation(true);

    setTimeout(() => {
      const encodedText = encodeURIComponent(waText);
      window.open(`https://wa.me/917669071755?text=${encodedText}`, '_blank');
    ...
    <section className={`section ${styles.booking}`}>
      ...
      <div className="container" style={{ position: 'relative', zIndex: 2 }}>
        ...
        <div className={styles.altContact} data-aos="fade-up">
          <a href="tel:+917669071755" className={styles.altItem}>
            <span>📞</span>
            <div>
              <strong>Call Us</strong>
              <span>+91 76690 71755</span>
            </div>
          </a>
